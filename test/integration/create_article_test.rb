...
class CreateArticleTest < ActionDispatch::IntegrationTest
  ...
  test "get new article form and create article" do
    ...
    assert_difference 'Article.count', 1 do
      post articles_path, params: { article: { title: "My First Article",
                                               description: "This is the description of my first article" } }
      assert_response :redirect
    end
    follow_redirect!
    assert_response :success
    assert_match "My First Article", response.body
  end
  ...
  test "get new article form and reject invalid article submission" do
    ...
    assert_no_difference 'Article.count' do
      post articles_path, params: { article: { title: "no", description: "short" } }
    end
